...
const CONFIG = {
    ...
    valentineName: "Shirley",

    // The title that appears in the browser tab
    // You can use emojis! 💝 💖 💗 💓 💞 💕
    pageTitle: "IMPORTANTE 💝",
    ...
    questions: {
        first: {
            ...
            secretAnswer: "Por supuesto que si mi chifito! ❤️"           // Secret hover message
        },
        second: {
        ...
        third: {
            text: "Quieres ser mi San Valentín este sábado 14 de febrero del 2026? 🌹", // The big question!
